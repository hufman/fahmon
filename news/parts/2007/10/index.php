<div class="item">
	<a id="e2007-10-31T15_41_07.txt"></a>
	<h2 class="date">Wed Oct 31 15:41:07 CDT 2007</h2>
	<div class="blogbody">
		<h3 class="title">Trac notifications fixed/enabled</h3>
		<div class="item-description">
			<p>Trac's ticket system now sends out email notifications when tickets are created/modified. So if you have set up and email address in your profile, you will 
automatically be sent an email when replies are posted, or the bug you reported is fixed etc.</p>
<p>Emails are sent from trac(@)fahmon.net, but you will receive no response if you reply to this address</p>
		</div>
	</div>

	<div class="posted">
		<br />Posted by <span class="item-creator">Andrew Schofield</span>
| <a class="link" href="../../../archives/2007/10/31/index.php#e2007-10-31T15_41_07.txt">Permanent Link</a>
| Categories: <!-- Website --><a href="../../../archives/website/index.php">Website</a>
<!--<a href="../../../../cgi-bin/cgicomment.cgi?article=archives/2007/10/31/index.php#e2007-10-31T15_41_07.txt#comments" target="_blank" >Comments</a>//-->
<?php
 $post_url=parse_url('http://fahmon.net/news/archives/2007/10/31/index.php#e2007-10-31T15_41_07.txt', PHP_URL_PATH); 
 $blog_id='e2007-10-31T15_41_07.txt';
...
<div class="item">
	<a id="e2007-10-22T16_25_51.txt"></a>
	<h2 class="date">Mon Oct 22 16:25:51 CDT 2007</h2>
	<div class="blogbody">
		<h3 class="title">Trac permissions fixed </h3>
		<div class="item-description">
			<p>Shello alerted me that the permission were set up wrong in trac which meant that new users couldn't 
...
reports and feature requests.</p>
	...
	<div class="posted">
		<br />Posted by <span class="item-creator">Andrew Schofield</span>
| <a class="link" href="../../../archives/2007/10/22/index.php#e2007-10-22T16_25_51.txt">Permanent Link</a>
| Categories: <!-- Website --><a href="../../../archives/website/index.php">Website</a>
<!--<a href="../../../../cgi-bin/cgicomment.cgi?article=archives/2007/10/22/index.php#e2007-10-22T16_25_51.txt#comments" target="_blank" >Comments</a>//-->
<?php
 $post_url=parse_url('http://fahmon.net/news/archives/2007/10/22/index.php#e2007-10-22T16_25_51.txt', PHP_URL_PATH); 
 $blog_id='e2007-10-22T16_25_51.txt';
 $blog_mail='andrew_s@fahmon.net';
 define (BK_PATH, "/home/salamander/webapps/fahmon/news/blogkomm");
 include (BK_PATH."/module/blogkomm_show_link.php");
?>
