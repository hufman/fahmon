...
/*The following line appears to be redundant as wxWidgets seems to use a 2000 epoch*/
...
/**
* Format of queue.dat. The queue is accesible as a struct of type queue
...
/**
* 4-byte endian swap
* The internal wxWidgets macro probably works too
**/
u32 es32(u32 i)
{
...
**/
void eswp(struct queue *bp, u32 qver, u32 systype)
{
	int               i, n;
	struct queue::qs *p;
